...
(function() {
	...
	gtagScript.src = "https://www.googletagmanager.com/gtag/js?id=UA-98865610-4";
	document.getElementsByTagName("head")[0].appendChild(gtagScript);

	var gtagSrc = document.createElement("script");
	gtagSrc.appendChild(document.createTextNode(decodeURIComponent("window.dataLayer%20%3D%20window.dataLayer%20%7C%7C%20%5B%5D%3B%0A%20%20function%20gtag()%7BdataLayer.push(arguments)%3B%7D%0A%20%20gtag('js'%2C%20new%20Date())%3B%0A%0A%20%20gtag('config'%2C%20'UA-98865610-4')%3B")));
